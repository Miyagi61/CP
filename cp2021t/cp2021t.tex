...
\>[B]{}\Varid{deCasteljau}\mathbin{::}[\mskip1.5mu \Conid{NPoint}\mskip1.5mu]\to \Conid{OverTime}\;\Conid{NPoint}{}\<[E]%
\\
\>[B]{}\Varid{deCasteljau}\mathrel{=}\bot \mbox{\onelinecomment  hyloAlgForm alg coalg where}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mbox{\onelinecomment  coalg = undefined}{}\<[E]%
\\
\>[B]{}\mbox{\onelinecomment    alg = either (const nil) (uncurry calcLine_h2)}{}\<[E]%
\\[\blanklineskip]%
